var DZHIMenu = newMenu("DZHI Menu Tool", newArray("PSR Analysis")); 

macro "DZHI Menu Tool - B00C0ffL1315L1719L1b1cL2126L2828L2a2dL3233Cf00L3738C0ffL3c3dCf00L444bC0ffL4d4dCf00L555aL5c5cL6669L6b6dL7778L7a7eL898fL9798L9a9eLa6a9LabadLb5baLbcbcLc4cbC0ffLcdcdLd2d3Cf00Ld7d8C0ffLdcddLe1e6Le8e8LeaedLf3f5Lf7f9Lfbfc"{
	cmd = getArgument();
	...
	if(cmd == "PSR Analysis"){
		...
		if(PERFORM_SEGMENTATION){
			...
			setForegroundColor(0,0,0);
			getDimensions(width, height, channels, slices, frames);
			setFont("SansSerif", minOf(width, height)/17, "bold");
			drawString("RV", rx, ry);
			drawString("LV", lx, ly);
		...
		if(PERFORM_ANALYSIS){
			...
			for(i=0; i<resultCount/2; i++){
				...
				setResult("Mean Collagen Intensity", i, getResult("Mean", 2*i+1));
				setResult("Max Collagen Intensity", i, getResult("max", 2*i+1));
